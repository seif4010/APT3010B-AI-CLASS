    ...
    def getheur(vertex, goal):
        ...
        for i in Environment.myheuristics[vertex]:
            ...
            for i in Environment.myheuristics[goal]:
                g.append(int(i))
                # getting the difference between x and y
        ...
        while True:
            ...
            for i in neighbour.difference(p):
                ...
                if x == goal:
                    ...
                    start = x
    # A* algorithm gets the start and the Goal
...
# hill climbing search algorithm
    ...
    def __init__(self, Environment):
        ...
        print("GBFS Paths for a hueristics")
        print(Agent.gbfs(Environment.mygraph, Environment.State, Environment.Goal))
        # returns greedy and best hueristic routes
        print("A_star Path for a hueristics and cost")
        print(Agent.A_Star(Environment.mygraph,
              Environment.State, Environment.Goal))
        # returns A_Star and hueristic and the cost routes
